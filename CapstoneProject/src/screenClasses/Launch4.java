...
public class Launch4 extends LaunchScreen{
	 ...
	 */
	public Launch4(DrawingSurface surface) {
	...
	public void draw() { // move the screen according to speed of rocket
		...
		if(Math.pow(imgX + 450 - rocket.getX(), 2) + Math.pow(imgY - img3.height -(sky1.height*2) - rocket.getY(), 2) > 140000 && !isDone) { 
			...
			surface.image(sky1, imgX, this.imgY-(sky1.height*4));
			surface.image(img3, (float) this.imgX, (float) this.imgY-(sky1.height*4)-img3.height);
